...
function Footer() {
  ...
  <div>
  <div style={{height:'120px', width:'120px'}}  className='logoDiv'></div>
    ...
    <p className="font-bold">
      {/* WALDCARDS  */}
      <br/> <ion-icon name="heart-outline"></ion-icon> Sending love and happiness <ion-icon name="heart-outline"></ion-icon>
    </p> 
   
    <p>Designed by Waldcards.de</p>
  </div> 
  <div>
